...
public final class ModBlocks {
    ...
    public static final BarrelBlock COPPER_BARREL = block(Utils.id("copper_barrel"));
    ...
    public static final MiniStorageBlock COPPER_MINI_BARREL = block(Utils.id("copper_mini_barrel"));
